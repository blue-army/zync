...
function createLibrary(connector: teams.TeamsChatConnector): builder.Library {
    ...
    lib.dialog('channelInfo',
        function (session: builder.Session) {
            ...
            utils.fetchChannelList(session, connector)
                .then((channels) => {
    ...
    lib.dialog('userInfo',
        function (session: builder.Session) {
            ...
            utils.fetchChannelMembers(session, connector)
                .then((users) => {
